...
//    self.navigationItem.title = [NSString stringWithFormat:@"选择照片"];
    ...
    UIBarButtonItem *barItem  = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"back1"] style:UIBarButtonItemStylePlain target:self action:@selector(goBack)];
