...
@interface GJLoginController () <GJLoginViewDelegate>
...
- (void)submitBtnClick {
    // 上线审核
    if ([_loginView.phoneNumTF.text isEqualToString:@"18786708783"] && _loginView.verifyCodeTF.text.length > 0) {
        [self requestLogin:@"18786708783" code:_loginView.verifyCodeTF.text];
        return;
    }
...
//    }
    ...
    [self requestLogin:_loginView.phoneNumTF.text code:_loginView.verifyCodeTF.text];
}
